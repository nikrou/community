...
$lang['Phyxo automatically creates an album for each user, on first connection'] = 'Phyxo skapar automatiskt ett album för alla andvändare, vid första inloggniing';
$lang['User album only'] = 'Endast användaralbum';
$lang['User albums'] = 'Användaralbum';
$lang['Where should Phyxo create user albums?'] = 'Var ska Phyxo skapa användaralbums?';
