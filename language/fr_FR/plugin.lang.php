...
$lang['Phyxo automatically creates an album for each user, on first connection'] = 'Phyxo créée automatiquement un album pour chaque utilisateur, lors de sa première connexion';
$lang['Where should Phyxo create user albums?'] = 'Où Phyxo doit-il créer les albums utilisateur ?';
