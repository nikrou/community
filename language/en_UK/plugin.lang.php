...
$lang['Phyxo automatically creates an album for each user, on first connection'] = 'Phyxo automatically creates an album for each user, on first connection';
$lang['Where should Phyxo create user albums?'] = 'Where should Phyxo create user albums?';
